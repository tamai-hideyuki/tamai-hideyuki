...
| リポジトリ名 | 説明 |
|--------------|------|
| [brain-cabinet](https://github.com/tamai-hideyuki/brain-cabinet.git) | 思考や判断のノートを自然言語処理で解析し、内容の意味や関係性をクラスタリングして「自分の思考傾向・成長パターン」を可視化するシステム。いわば、思考ログを活用して自分の意思決定を支援する“外部脳”のような仕組み |
